...
public class Plant extends ClockDomain{
  ...
  public void thread3685(int [] tdone, int [] ends){
      ...
      case 1 : 
        ...
        int biggest3692 = 0;
        if(ends[8]>=biggest3692){
          biggest3692=ends[8];
        }
        if(ends[9]>=biggest3692){
          biggest3692=ends[9];
        }
        if(ends[10]>=biggest3692){
          biggest3692=ends[10];
        }
        if(ends[11]>=biggest3692){
          biggest3692=ends[11];
        }
        if(ends[12]>=biggest3692){
          biggest3692=ends[12];
        }
        if(ends[13]>=biggest3692){
          biggest3692=ends[13];
        }
        if(biggest3692 == 1){
          active[7]=1;
  ...
  public void thread3671(int [] tdone, int [] ends){
    ...
    int biggest3678 = 0;
    if(ends[8]>=biggest3678){
      biggest3678=ends[8];
    }
    if(ends[9]>=biggest3678){
      biggest3678=ends[9];
    }
    if(ends[10]>=biggest3678){
      biggest3678=ends[10];
    }
    if(ends[11]>=biggest3678){
      biggest3678=ends[11];
    }
    if(ends[12]>=biggest3678){
      biggest3678=ends[12];
    }
    if(ends[13]>=biggest3678){
      biggest3678=ends[13];
    }
    if(biggest3678 == 1){
      active[7]=1;
    ...
    RUN: while(true){
      switch(S3664){
        ...
        case 1 : 
          ...
          int biggest3679 = 0;
          if(ends[2]>=biggest3679){
            biggest3679=ends[2];
          }
          if(ends[3]>=biggest3679){
            biggest3679=ends[3];
          }
          if(ends[4]>=biggest3679){
            biggest3679=ends[4];
          }
          if(ends[5]>=biggest3679){
            biggest3679=ends[5];
          }
          if(ends[6]>=biggest3679){
            biggest3679=ends[6];
          }
          if(ends[7]>=biggest3679){
            biggest3679=ends[7];
          }
          if(biggest3679 == 1){
            active[1]=1;
        ...
        case 2 : 
          ...
          int biggest3693 = 0;
          if(ends[2]>=biggest3693){
            biggest3693=ends[2];
          }
          if(ends[3]>=biggest3693){
            biggest3693=ends[3];
          }
          ...
          if(ends[6]>=biggest3693){
            biggest3693=ends[6];
          }
          if(ends[7]>=biggest3693){
            biggest3693=ends[7];
          }
          if(biggest3693 == 1){
            active[1]=1;

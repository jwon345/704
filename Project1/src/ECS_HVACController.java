...
public class ECS_HVACController extends ClockDomain{
  ...
  private int S213641 = 1;
  private int S204046 = 1;
  private int S204030 = 1;
  private int S208170 = 1;
  private int S204048 = 1;
  private int S204089 = 1;
  private int S204056 = 1;
  private int S204064 = 1;
  private int S204174 = 1;
  private int S204141 = 1;
  private int S204149 = 1;
  private int S208502 = 1;
  private int S208226 = 1;
  private int S208172 = 1;
  private int S208200 = 1;
  private int S208834 = 1;
  private int S208558 = 1;
  private int S208504 = 1;
  private int S208532 = 1;
  
  private int[] ends = new int[66];
  private int[] tdone = new int[66];
  
  public void thread215008(int [] tdone, int [] ends){
        switch(S208834){
      case 0 : 
        active[5]=0;
        ends[5]=0;
  ...
  public void thread215007(int [] tdone, int [] ends){
        switch(S208502){
      case 0 : 
        active[4]=0;
        ends[4]=0;
  ...
  public void thread215006(int [] tdone, int [] ends){
        switch(S208170){
      case 0 : 
        active[3]=0;
        ends[3]=0;
  ...
  public void thread215005(int [] tdone, int [] ends){
        switch(S204046){
      case 0 : 
        active[2]=0;
        ends[2]=0;
  ...
  public void thread215003(int [] tdone, int [] ends){
        S208834=1;
  ...
  public void thread215002(int [] tdone, int [] ends){
        S208502=1;
  ...
  public void thread215001(int [] tdone, int [] ends){
        S208170=1;
  ...
  public void thread215000(int [] tdone, int [] ends){
        S204046=1;
    S204030=0;
    active[2]=1;
    ends[2]=1;
    ...
    RUN: while(true){
      switch(S213641){
        ...
        case 1 : 
          ...
          thread215000(tdone,ends);
          thread215001(tdone,ends);
          thread215002(tdone,ends);
          thread215003(tdone,ends);
          int biggest215004 = 0;
          if(ends[2]>=biggest215004){
            biggest215004=ends[2];
          }
          if(ends[3]>=biggest215004){
            biggest215004=ends[3];
          }
          if(ends[4]>=biggest215004){
            biggest215004=ends[4];
          }
          if(ends[5]>=biggest215004){
            biggest215004=ends[5];
          }
          if(biggest215004 == 1){
            active[1]=1;
            ends[1]=1;
        ...
        case 2 : 
          workhrs_1.setClear();//sysj\ECS.sysj line: 83, column: 2
          afterhrs_1.setClear();//sysj\ECS.sysj line: 83, column: 2
          thread215005(tdone,ends);
          thread215006(tdone,ends);
          thread215007(tdone,ends);
          thread215008(tdone,ends);
          int biggest215009 = 0;
          if(ends[2]>=biggest215009){
            biggest215009=ends[2];
          }
          if(ends[3]>=biggest215009){
            biggest215009=ends[3];
          }
          if(ends[4]>=biggest215009){
            biggest215009=ends[4];
          }
          if(ends[5]>=biggest215009){
            biggest215009=ends[5];
          }
          if(biggest215009 == 1){
            active[1]=1;
            ends[1]=1;
